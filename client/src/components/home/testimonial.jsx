    ...
    return (
        ...
        <div>
         <div id="testimonial" className="flex flex-col items-center my-10 scroll-mt-12">
            <div className="flex items-center gap-2 text-sm text-orange-300 bg-orange-600 rounded-full
            px-6 py-1.5">
                <BookUserIcon className="size-4.5" />
                <span>Testimonials</span>

            </div>

       <Title title='Dont just take our words' 
       description={'Here about what our users say about us. we are always looking for ways to improve,if you have a positive exprience with us'}/>
